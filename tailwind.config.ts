  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { opacity: "1", boxShadow: "0 0 20px hsl(0 75% 50% / 0.4)" },
          "50%": { opacity: "0.85", boxShadow: "0 0 50px hsl(0 75% 50% / 0.6)" },
        },
        "urgent-slide": {
      ...
      animation: {
        ...
        "urgent-slide": "urgent-slide 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards",
